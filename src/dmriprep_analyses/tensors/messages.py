...
INVALID_PARTICIPANT = "participant_label must describe an existing participant in DMRIPrep derivatives' directory ({base_dir}), but a value of {participant_label} was passed."  # noqa
#: Warnings
